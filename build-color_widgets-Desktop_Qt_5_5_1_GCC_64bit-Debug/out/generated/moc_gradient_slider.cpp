...
#include "../../../Qt-Color-Widgets-master/include/gradient_slider.hpp"
...
const QMetaObject color_widgets::GradientSlider::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_color_widgets__GradientSlider.data,
      qt_meta_data_color_widgets__GradientSlider,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *color_widgets::GradientSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_color_widgets__GradientSlider.stringdata0))
        return static_cast<void*>(const_cast< GradientSlider*>(this));
