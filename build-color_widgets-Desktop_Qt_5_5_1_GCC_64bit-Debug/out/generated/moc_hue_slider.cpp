...
#include "../../../Qt-Color-Widgets-master/include/hue_slider.hpp"
...
const QMetaObject color_widgets::HueSlider::staticMetaObject = {
    { &GradientSlider::staticMetaObject, qt_meta_stringdata_color_widgets__HueSlider.data,
      qt_meta_data_color_widgets__HueSlider,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *color_widgets::HueSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_color_widgets__HueSlider.stringdata0))
        return static_cast<void*>(const_cast< HueSlider*>(this));
